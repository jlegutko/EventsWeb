 ...
 */
final class Version20190815111401 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE events (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT UNSIGNED NOT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, event_date DATETIME NOT NULL, price DOUBLE PRECISION NOT NULL, is_active TINYINT(1) NOT NULL, place VARCHAR(255) NOT NULL, event_size VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_5387574A12469DE2 (category_id), INDEX IDX_5387574AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
