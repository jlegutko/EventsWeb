 ...
 */
final class Version20190903205547 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users ADD profile_pic VARCHAR(191) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
