 ...
 */
final class Version20190826202816 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE posts (id INT AUTO_INCREMENT NOT NULL, discussion_id INT NOT NULL, user_id INT UNSIGNED NOT NULL, content VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_885DBAFA1ADED311 (discussion_id), INDEX IDX_885DBAFAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE profile_photo (id INT AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED DEFAULT NULL, file VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_E3631BCAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE profile_photo ADD CONSTRAINT FK_E3631BCAA76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profile_photo DROP FOREIGN KEY FK_E3631BCAA76ED395');
